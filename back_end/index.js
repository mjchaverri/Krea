...
const Talentos = require("./src/models/Talentos")
const Tipos_talentos = require("./src/models/Tipos_talentos")
const Tipos_para_convos = require("./src/models/Tipo_para_convos")
const Portafolios = require("./src/models/Portafolios")
const Resenas = require("./src/models/Resenas")
const Componentes = require("./src/models/Componentes")
const Bloques_Componentes = require("./src/models/Bloques_Componentes")
const Componentes_estilos = require("./src/models/Componentes_estilos")
const Convocatorias = require("./src/models/Convocatoria")
const Participante_convo = require("./src/models/Participante_convo")
const Reporte_convo = require("./src/models/Reporte_convo")
const Tipo_convo = require("./src/models/Tipo_convo")
const Categorias = require("./src/models/Categorias")
const Categoria_portafolios = require("./src/models/Categoria_portafolios")
const Comunidades = require("./src/models/Comunidades")
const Miembros = require("./src/models/Miembros")
const Chat_Comu = require("./src/models/Chat_Comu")
const Chat_Miembros = require("./src/models/Chat_Miembros")
const Seguidos = require("./src/models/Seguidos")
